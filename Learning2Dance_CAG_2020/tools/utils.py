...
def make_video(name,predictions,n,normalized=3):
    ...
    out_video = cv2.VideoWriter(name+'_black.mp4', cv2.VideoWriter_fourcc(*'H264'), 15.0, (w, h))
    out_video_white = cv2.VideoWriter(name+'_white.mp4', cv2.VideoWriter_fourcc(*'H264'), 15.0, (w, h))
